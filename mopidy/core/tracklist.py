...
class TracklistController:
    ...
    def _remove_tracks(self, tl_tracks, *, stop_if_current=True):
        ...
        # Check to see if we're removing the current tl_track
        # and stop playback if we are
        # If we don't do this the track keeps playing and we no longer
        # have a reference to it

        current_track = self.core.playback.get_current_tl_track()
        if stop_if_current and current_track in tl_tracks:
